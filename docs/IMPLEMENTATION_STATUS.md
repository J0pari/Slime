...
BUILD phase incomplete: 4 of 9 inventory items are not implemented (I6, I7, I8, I9). No GPU integration, acceptance, or production run is permitted, and `evidence.py record` refuses GPU manifests.
