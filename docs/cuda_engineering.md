...
@claim S001.cuda-errors-fatal contract
...
At world initialization, emit CUDA-native startup telemetry: device name,
compute capability, SM count, global/free memory, memory bus and clock,
asynchronous copy engines, block limit, concurrent-kernel/UVA/managed-memory
