"""Real benchmark datasets from HuggingFace and standard ML sources"""
...
class GLUEDataset(Dataset):
    """GLUE benchmark tasks: SST-2, MRPC, CoLA, MNLI, QNLI, QQP, RTE, WNLI, STS-B"""
...
class CIFAR10Dataset(Dataset):
    """CIFAR-10 32x32 RGB natural images"""
...
def create_benchmark_dataset(dataset_name: str, split: str = "train", **kwargs) -> Dataset:
    ...
    Real: glue_sst2, glue_mrpc, glue_cola, mnist, cifar10, imdb, wikitext
    Toy: sin, xor, parity
    """
    ...
    datasets = {
        ...
        'sin': lambda: SinDataset(**kwargs),
        'xor': lambda: XORDataset(**kwargs),
        'parity': lambda: ParityDataset(**kwargs),
    }
