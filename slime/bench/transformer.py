...
class TransformerBaseline(nn.Module):
    ...
    This is the architecture we're competing against.
...
class FlashAttentionBaseline(nn.Module):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList([
            FlashAttentionLayer(d_model, nhead, dim_feedforward, dropout, self.device)
...
class FlashAttentionLayer(nn.Module):
    """Single layer with flash attention"""
...
def create_baseline(baseline_type: str, **kwargs) -> nn.Module:
    ...
    baselines = {
        ...
        'flash_attention': FlashAttentionBaseline,
    }
