...
#define DATASET_REGISTRY_INIT { \
    { \
        ...
        MNIST_TRAIN_SAMPLES * MNIST_ROWS * MNIST_COLS, MNIST_TEST_SAMPLES * MNIST_ROWS * MNIST_COLS, \
        true, false, \
        0, 0, 0, \
    ...
    { \
        ...
        FASHION_MNIST_TRAIN_SAMPLES * FASHION_MNIST_ROWS * FASHION_MNIST_COLS, FASHION_MNIST_TEST_SAMPLES * FASHION_MNIST_ROWS * FASHION_MNIST_COLS, \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_8, false, 0, 0 \
    }, \
    { \
        ...
        CIFAR10_TRAIN_SAMPLES * CIFAR10_ROWS * CIFAR10_COLS * CIFAR10_CHANNELS, CIFAR10_TEST_SAMPLES * CIFAR10_ROWS * CIFAR10_COLS * CIFAR10_CHANNELS, \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_8, false, 0, 0 \
    }, \
    { \
        ...
        PATHMNIST_TRAIN_SAMPLES * PATHMNIST_ROWS * PATHMNIST_COLS * PATHMNIST_CHANNELS, PATHMNIST_TEST_SAMPLES * PATHMNIST_ROWS * PATHMNIST_COLS * PATHMNIST_CHANNELS, \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_8, false, 0, 0 \
    }, \
    { \
        ...
        ESC50_TRAIN_SAMPLES * AUDIO_TIME_LONG * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), ESC50_TEST_SAMPLES * AUDIO_TIME_LONG * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), \
        false, true, \
    ...
    { \
        ...
        SPEECH_COMMANDS_TRAIN_SAMPLES * AUDIO_TIME_SHORT * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), SPEECH_COMMANDS_TEST_SAMPLES * AUDIO_TIME_SHORT * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), \
        false, false, \
    ...
    { \
        ...
        URBANSOUND8K_TRAIN_SAMPLES * AUDIO_TIME_MEDIUM * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), URBANSOUND8K_TEST_SAMPLES * AUDIO_TIME_MEDIUM * AUDIO_N_MELS * AUDIO_SPEC_CHANNELS * sizeof(float), \
        false, true, \
    ...
    { \
        ...
        UCIHAR_TRAIN_SAMPLES * UCIHAR_TIMESTEPS * UCIHAR_FEATURES * sizeof(float), UCIHAR_TEST_SAMPLES * UCIHAR_TIMESTEPS * UCIHAR_FEATURES * sizeof(float), \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_16, false, 0, 0 \
    }, \
    { \
        ...
        MITBIH_TRAIN_SAMPLES * MITBIH_TIMESTEPS * sizeof(float), MITBIH_TEST_SAMPLES * MITBIH_TIMESTEPS * sizeof(float), \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_16, false, 0, 0 \
    }, \
    { \
        ...
        OPPORTUNITY_TRAIN_SAMPLES * OPPORTUNITY_TIMESTEPS * OPPORTUNITY_FEATURES * sizeof(float), OPPORTUNITY_TEST_SAMPLES * OPPORTUNITY_TIMESTEPS * OPPORTUNITY_FEATURES * sizeof(float), \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_16, false, 0, 0 \
    }, \
    { \
        ...
        CHESTXRAY_TRAIN_SAMPLES * CHESTXRAY_ROWS * CHESTXRAY_COLS, CHESTXRAY_TEST_SAMPLES * CHESTXRAY_ROWS * CHESTXRAY_COLS, \
        true, false, \
        0, 0, 0, \
    ...
    { \
        ...
        RETINAMNIST_TRAIN_SAMPLES * RETINAMNIST_ROWS * RETINAMNIST_COLS * RETINAMNIST_CHANNELS, RETINAMNIST_TEST_SAMPLES * RETINAMNIST_ROWS * RETINAMNIST_COLS * RETINAMNIST_CHANNELS, \
        true, false, \
        0, 0, 0, \
        false, BIT_DEPTH_8, false, 0, 0 \
    } \
...
__global__ void inject_sample_to_ca_kernel(
    ...
    float sample_value = batch[batch_idx * grid_size * grid_size + y * grid_size + x];
    ...
    int base_idx = batch_idx * grid_size * grid_size * channels + y * grid_size * channels + x * channels;
    for (int c = 0; c < channels; c++) {
        ca_state[base_idx + c] = sample_value;
    }
}
