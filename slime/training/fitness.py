...
class FitnessComputer:
    """Compute fitness metrics based on gradient magnitudes.

    Fitness MUST correlate with task performance.
    Components with high gradients affect loss more = high fitness.
    Components with low gradients are irrelevant = low fitness.
    """
    ...
    def compute_combined_fitness(
        ...
        Args:
            ...
            attention_weight: Weight for attention fitness
        ...
        """
        total_weight = gradient_weight + attention_weight + information_weight
