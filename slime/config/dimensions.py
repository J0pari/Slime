...
TINY = ArchitectureConfig(
    ...
    behavioral_space=BehavioralSpaceConfig(num_raw_metrics=10, min_dims=3, max_dims=5, num_centroids=50),
...
SMALL = ArchitectureConfig(
    ...
    behavioral_space=BehavioralSpaceConfig(num_raw_metrics=15, min_dims=4, max_dims=6, num_centroids=200),
...
MEDIUM = ArchitectureConfig(
    ...
    behavioral_space=BehavioralSpaceConfig(num_raw_metrics=15, min_dims=5, max_dims=7, num_centroids=500),
...
LARGE = ArchitectureConfig(
    ...
    behavioral_space=BehavioralSpaceConfig(num_raw_metrics=20, min_dims=5, max_dims=7, num_centroids=1000),
