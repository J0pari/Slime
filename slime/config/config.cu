...
constexpr size_t DIRESA_TASK_STRIDE_PER_ENTRY =
    ...
    DIRESA_HIDDEN2_MAX * BEHAVIORAL_DIM_TASK_MAX + BEHAVIORAL_DIM_TASK_MAX +
    BEHAVIORAL_DIM_TASK_MAX * DIRESA_HIDDEN2_MAX + DIRESA_HIDDEN2_MAX +
    DIRESA_HIDDEN2_MAX * DIRESA_HIDDEN1_MAX + DIRESA_HIDDEN1_MAX +
    DIRESA_HIDDEN1_MAX * DIRESA_TASK_INPUT_DIM_MAX + DIRESA_TASK_INPUT_DIM_MAX;
